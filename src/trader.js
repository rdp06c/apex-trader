                            ...
                            <div class="holding-card-timeframe">
                                ...
                                <span class="text-muted" style="margin-left:8px">| Mtm: <strong>${entryMomentum != null ? entryMomentum.toFixed(1) : '--'}</strong> · RS: <strong>${entryRS != null ? entryRS.toFixed(0) : '--'}</strong>${(() => {
                                    ...
                                    if (bars && bars.length >= 14) {
                                        ...
                                        if (macdResult) {
                                            const mc = macdResult.crossover === 'bullish' ? 'macd-bullish' : macdResult.crossover === 'bearish' ? 'macd-bearish' : 'macd-neutral';
                                            const arrow = macdResult.crossover === 'bullish' ? '▲' : macdResult.crossover === 'bearish' ? '▼' : '—';
...
- Recent Transactions: ${JSON.stringify(recentTransactions)}`,
        ...
        function updateCandidateScorecard() {
            ...
            data.candidates.forEach((c, i) => {
                ...
                const macdArrow = macdCross === 'bullish' ? '▲' : macdCross === 'bearish' ? '▼' : '—';
                const macdClass = macdCross === 'bullish' ? 'macd-bullish' : macdCross === 'bearish' ? 'macd-bearish' : 'macd-neutral';
