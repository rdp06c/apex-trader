...
Remember: You're managing real money to MAXIMIZE returns through INFORMED decisions AND teaching your user. Back every decision with research. Be specific. Explain your conviction.`
        ...
        function analyzeSignalCombos(observations, showAll = false) {
            ...
            const sectorFlowInflow = f => f === 'inflow' || f === 'accumulate' || f === 'favorable' || f === 'modest-inflow';
            ...
            const comboDefs = [
                ...
                { id: 'sector_inflow_structure', label: 'Sector Inflow + Bull Structure', tier: 1, filter: s => sectorFlowInflow(s.sectorFlow) && (s.structureScore ?? 0) >= 2 },
                ...
                { id: 'rsi_low_sector_inflow', label: 'RSI<40 + Sector Inflow', tier: 1, filter: s => s.rsi != null && s.rsi < 40 && sectorFlowInflow(s.sectorFlow) },
                // Tier 2: Key Triples
                ...
                { id: 'triple_oversold', label: 'RSI<30 + Structure + Sector Inflow', tier: 2, filter: s => s.rsi != null && s.rsi < 30 && (s.structureScore ?? 0) >= 2 && sectorFlowInflow(s.sectorFlow) },
