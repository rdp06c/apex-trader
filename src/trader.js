        ...
        // R:R at buy zone limit entry: target projected from buy zone price (stable),
        // stop from trade plan (structure-based). Avoids R:R drift as current price moves.
        function computeBuyZoneRR(tradePlan, buyZonePrice) {
            if (!tradePlan || !buyZonePrice || !tradePlan.atr) return null;
            ...
            return { riskReward, improvementVsCurrent, target: +target.toFixed(2) };
        }
