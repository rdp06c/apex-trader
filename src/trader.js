                    ...
                    detailHtml += `
                        <div class="holding-item holding-card">
                            ...
                            <div class="holding-card-levels">
                                ${_atrStop ? '<span class="level-item"><span class="holding-card-footer-label">ATR Stop:</span> <span class="holding-card-footer-value ' + (stockPrice.price <= _atrStop ? 'negative' : '') + '">$' + _atrStop.toFixed(2) + '</span></span>' : ''}
                                ${_fib?.type === 'bullish' ? '<span class="level-item"><span class="holding-card-footer-label">Fib Target:</span> <span class="holding-card-footer-value ' + (stockPrice.price >= _fib.fib1272 ? 'positive' : '') + '">$' + _fib.fib1272.toFixed(2) + '</span> · <span class="holding-card-footer-value ' + (stockPrice.price >= _fib.fib1618 ? 'positive' : '') + '">$' + _fib.fib1618.toFixed(2) + '</span></span>' : ''}
                            </div>
                            ${(() => {
