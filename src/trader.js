...
- **AVOID**: Anti-pattern — should not have been entered. Flag for immediate review.`;
        ...
        function updateCandidateScorecard() {
            ...
            if (_rsMin != null || _rsMax != null || _rsiMin != null || _rsiMax != null || _momMin != null || _momMax != null || _macdF || _structF) {
                candidates = candidates.filter(c => {
                    ...
                    if (_macdF) {
                        ...
                        if (_macdF === 'bullish' && cross !== 'bullish') return false;
                        if (_macdF === 'bearish' && cross !== 'bearish') return false;
                    }
                    if (_structF) {
            ...
            html += '<span class="tech-filter-label" style="min-width:auto;">Filters:</span>';
            ...
            html += `<select onchange="scorecardSetTechFilter('filterMacd',this.value)" class="scorecard-sector-filter"><option value="">MACD: Any</option><option value="bullish"${scorecardState.filterMacd === 'bullish' ? ' selected' : ''}>MACD: Bullish</option><option value="bearish"${scorecardState.filterMacd === 'bearish' ? ' selected' : ''}>MACD: Bearish</option></select>`;
