...
- Recent Transactions: ${JSON.stringify(recentTransactions)}`,
        ...
        const scorecardState = { page: 1, filterSector: '', sortField: 'score', sortDir: 'desc' };
        ...
        function updateCandidateScorecard() {
            ...
            // Already sorted by score desc from scan — apply sector filter
            ...
            // Controls: sector filter + pagination
