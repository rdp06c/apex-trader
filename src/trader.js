        ...
        const SIGNAL_COMBO_DEFS = [
            ...
            { id: 'breakout_sma_vol', label: 'SMA Bull Cross + Structure + RSI<55', tier: 2, filter: s => s.smaCrossover?.crossover === 'bullish' && (s.structureScore ?? 0) >= 1 && s.rsi != null && s.rsi < 55 },
            ...
            { id: 'mean_revert_vol', label: 'Ret5d -2/-5% + Bull Struct + Not Outflow', tier: 1, filter: s => (s.totalReturn5d ?? 0) >= -5 && (s.totalReturn5d ?? 0) <= -2 && (s.structureScore ?? 0) >= 2 && s.sectorFlow !== 'outflow' && s.sectorFlow !== 'avoid' },
        ];
