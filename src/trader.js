        ...
        function calculateFibTargets(bars) {
            ...
            if (lastSL.index < lastSH.index) {
                ...
                return { type: 'bullish', swingLow: Math.round(lastSL.price * 100) / 100, swingHigh: Math.round(lastSH.price * 100) / 100, fib1272: Math.round((pullback + swingRange * 1.272) * 100) / 100, fib1618: Math.round((pullback + swingRange * 1.618) * 100) / 100 };
            }
            if (lastSH.index < lastSL.index) {
                const swingRange = lastSH.price - lastSL.price;
                const bounce = currentPrice > lastSL.price ? currentPrice : lastSH.price;
                return { type: 'bearish', swingHigh: Math.round(lastSH.price * 100) / 100, swingLow: Math.round(lastSL.price * 100) / 100, fib1272: Math.round((bounce - swingRange * 1.272) * 100) / 100, fib1618: Math.round((bounce - swingRange * 1.618) * 100) / 100 };
            }
            return null;
        }
            ...
            if (manualTradeMode === 'buy') {
                ...
                const newThesis = {
                    ...
                    targetPrice: (() => {
                        ...
                        return fib?.type === 'bullish' ? fib.fib1272 : null;
                    })(),
                    stopPrice: (() => {
