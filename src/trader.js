        ...
        const stockNames = {
            ...
            'CYBR': 'CyberArk', 'VRNT': 'Verint', 'ASAN': 'Asana', 'SQSP': 'Squarespace',
            'FIVN': 'Five9', 'RBRK': 'Rubrik', 'ZI': 'ZoomInfo', 'DT': 'Dynatrace',
            'TWLO': 'Twilio', 'DBX': 'Dropbox', 'BOX': 'Box Inc.', 'JAMF': 'Jamf',
            'YOU': 'Clear Secure', 'SMTC': 'Semtech', 'CALX': 'Calix', 'PI': 'Impinj',
            'MANH': 'Manhattan Associates', 'GWRE': 'Guidewire', 'WK': 'Workiva',
            'ALTR': 'Altair Engineering', 'BSY': 'Bentley Systems', 'AZPN': 'Aspen Technology',
            'APPF': 'AppFolio', 'PCTY': 'Paylocity',
            ...
            'COLM': 'Columbia Sportswear', 'SKX': 'Skechers', 'VFC': 'VF Corp.',
            'GIII': 'G-III Apparel', 'OXM': 'Oxford Industries', 'HBI': 'Hanesbrands',
            'PVH': 'PVH Corp.', 'COTY': 'Coty', 'MNSO': 'Miniso',
            'AEO': 'American Eagle', 'ANF': 'Abercrombie & Fitch', 'GPS': 'Gap Inc.',
            'VSCO': "Victoria's Secret", 'BBWI': 'Bath & Body Works', 'RVLV': 'Revolve',
            'WRBY': 'Warby Parker', 'FL': 'Foot Locker', 'JWN': 'Nordstrom',
            'M': "Macy's", 'KSS': "Kohl's", 'BURL': 'Burlington',
            'PENN': 'Penn Entertainment', 'CZR': 'Caesars Entertainment',
            'BYD': 'Boyd Gaming', 'GDEN': 'Golden Entertainment', 'PLYA': 'Playa Hotels',
            'VAC': 'Marriott Vacations', 'MTN': 'Vail Resorts', 'SIX': 'Six Flags',
            'SEAS': 'SeaWorld',
            ...
            'UFPI': 'UFP Industries', 'AZEK': 'AZEK Company',
            ...
            'OFC': 'Corporate Office', 'NNN': 'NNN REIT', 'ADC': 'Agree Realty',
            ...
            'HCC': 'Warrior Met Coal', 'ARCH': 'Arch Resources',
            ...
            'OSIS': 'OSI Systems', 'VSE': 'VSE Corp.', 'BDC': 'Belden',
        ...
        const stockSectors = {
            ...
            'CYBR': 'Technology', 'VRNT': 'Technology', 'ASAN': 'Technology', 'SQSP': 'Technology',
            'FIVN': 'Technology', 'RBRK': 'Technology', 'ZI': 'Technology', 'DT': 'Technology',
            'TWLO': 'Technology', 'DBX': 'Technology', 'BOX': 'Technology', 'JAMF': 'Technology',
            'YOU': 'Technology', 'SMTC': 'Technology', 'CALX': 'Technology', 'PI': 'Technology',
            'MANH': 'Technology', 'GWRE': 'Technology', 'WK': 'Technology',
            'ALTR': 'Technology', 'BSY': 'Technology', 'AZPN': 'Technology',
            'APPF': 'Technology', 'PCTY': 'Technology',
            ...
            'COLM': 'Consumer', 'SKX': 'Consumer', 'VFC': 'Consumer',
            'GIII': 'Consumer', 'OXM': 'Consumer', 'HBI': 'Consumer',
            'PVH': 'Consumer', 'COTY': 'Consumer', 'MNSO': 'Consumer',
            'AEO': 'Consumer', 'ANF': 'Consumer', 'GPS': 'Consumer',
            'VSCO': 'Consumer', 'BBWI': 'Consumer', 'RVLV': 'Consumer',
            'WRBY': 'Consumer', 'FL': 'Consumer', 'JWN': 'Consumer',
            'M': 'Consumer', 'KSS': 'Consumer', 'BURL': 'Consumer',
            'PENN': 'Consumer', 'CZR': 'Consumer',
            'BYD': 'Consumer', 'GDEN': 'Consumer', 'PLYA': 'Consumer',
            'VAC': 'Consumer', 'MTN': 'Consumer', 'SIX': 'Consumer',
            'SEAS': 'Consumer',
            ...
            'STEM': 'Energy', 'NOVA': 'Energy', 'SHLS': 'Energy',
            'ORA': 'Energy', 'CWEN': 'Energy', 'TAC': 'Energy',
            'CNX': 'Energy', 'RRC': 'Energy', 'WFRD': 'Energy',
            'CHX': 'Energy', 'LBRT': 'Energy', 'PTEN': 'Energy',
            'HP': 'Energy',
            ...
            'UFPI': 'Industrials', 'AZEK': 'Industrials',
            ...
            'OFC': 'Real Estate', 'NNN': 'Real Estate', 'ADC': 'Real Estate',
            ...
            // Mid-cap Defense additions
            'OSIS': 'Defense', 'VSE': 'Defense', 'BDC': 'Defense',
            'EQT': 'Energy',
        ...
        async function screenStocks() {
            ...
            const stockLists = {
                techAI: ['NVDA', 'AVGO', 'GOOGL', 'MSFT', 'META', 'ORCL', 'CRM', 'ADBE', 'NOW', 'INTU',
                         ...
                         'CYBR', 'VRNT', 'ASAN', 'SQSP', 'FIVN', 'RBRK', 'ZI', 'DT',
                         'TWLO', 'DBX', 'BOX', 'JAMF', 'YOU', 'SMTC', 'CALX', 'PI',
                         'MANH', 'GWRE', 'WK', 'ALTR', 'BSY', 'AZPN', 'APPF', 'PCTY'],
                ...
                finance: ['JPM', 'BAC', 'WFC', 'GS', 'MS', 'C', 'BLK', 'SCHW', 'V', 'MA',
                          ...
                          // Mid-cap Financial
                          'WAL', 'EWBC', 'CMA', 'FNB', 'WTFC', 'PNFP', 'SSB', 'BOKF', 'GBCI',
                          'NYCB', 'OZK', 'SBCF', 'UMBF', 'FCNCA',
                ...
                consumer: ['AMZN', 'WMT', 'COST', 'TGT', 'HD', 'LOW', 'SBUX', 'MCD', 'CMG', 'YUM',
                           ...
                           'FIVE', 'OLLI', 'BJ', 'COLM', 'SKX', 'VFC',
                           'GIII', 'OXM', 'HBI', 'PVH', 'COTY', 'MNSO',
                           'AEO', 'ANF', 'GPS', 'VSCO', 'BBWI', 'RVLV',
                           'WRBY', 'FL', 'JWN', 'M', 'KSS', 'BURL',
                           'PENN', 'CZR', 'BYD', 'GDEN', 'PLYA',
                           'VAC', 'MTN', 'SIX', 'SEAS'],
                ...
                industrials: ['CAT', 'DE', 'CMI', 'EMR', 'ETN', 'PH', 'ROK', 'AME', 'DOV', 'ITW',
                              ...
                              'UFPI', 'AZEK', 'AWI', 'TREX', 'SITE', 'BFAM', 'HRI', 'WSC',
                              'SKYW', 'ALK', 'JBLU', 'AAL',
...
Remember: You're managing real money to MAXIMIZE returns through INFORMED decisions AND teaching your user. Back every decision with research. Be specific. Explain your conviction.`
        ...
        async function runCalibrationSweep(startDateStr, endDateStr, progressCallback) {
            ...
            // Fetch ALL dates in one pass (key optimization: ~230 calls vs ~3300)
            const masterBars = {};
...
- **AVOID**: Anti-pattern — should not have been entered. Flag for immediate review.`;
        ...
        const scorecardState = { page: 1, filterSector: '', filterHeld: false, filterSignal: 'reversal', filterWatchlist: false, filterZone: false, overrideRegimeGate: false, sortField: 'score', sortDir: 'desc' };
